...
- Upgrade pingora dependency to version 0.8.1
- Switch jokoway service image to local build in example compose files
...
- Update hickory-resolver to v0.26 and migrate to the new TokioResolver builder API
...
- Implement configurable load balancing strategies and fix health check concurrency issues
- Make UpstreamManager and associated configuration loading async and add readiness polling to tests
